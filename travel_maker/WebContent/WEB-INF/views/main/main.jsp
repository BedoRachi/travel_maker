...
<%@ taglib prefix="tiles" uri="http://tiles.apache.org/tags-tiles" %>
    ...
    <link rel="stylesheet" href="resources/main/css/plyr.css" type="text/css">
    ...
    <section class="hero">
        <div class="container">
            <div class="hero__slider owl-carousel">
                ...
                <div class="hero__items set-bg" data-setbg="resources/main/img/hero/main-1.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">#´ëÃ»È£</div>
                                 <h2 style="height: 104px; text-overflow: ellipsis; overflow: hidden;">
                                 	´ëÃæ ¿©±â´Ù ¼à¶ó¼à¶ó ½á³õ´Â Áß</h2>
                ...
                <div class="hero__items set-bg" data-setbg="resources/main/img/hero/main-2.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">#°æº¹±Ã</div>
                                 <h2 style="height: 104px; text-overflow: ellipsis; overflow: hidden;">
                              	   °Ü¿ï »Ó¸¸ÀÌ ¾Æ´Ï¶ó »ç°èÀýÀÇ Ç³°æÀÌ ¾Æ¸§´Ù¿î ¿ì¸®³ª¶óÀÇ Ç³°æ</h2>
                                <p>¼­¿ï½Ã ¸Ó½Ã±â °æº¹±Ã...</p>
                                <a href="#"><span>Detail</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                ...
                <div class="hero__items set-bg" data-setbg="resources/main/img/hero/main-3.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">#»ï°ã»ì</div>
                                <h2 style="height: 104px; text-overflow: ellipsis; overflow: hidden;">
                               	¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå¸Ô·Îµå
                                </h2>
                                <p>°èÀýÀ» Å¸Áö ¾Ê´Â ÇÑ±¹ÀÎÀÇ ÁÖ½Ä</p>
                                <a href="#"><span>Detail</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
...
<script src="resources/main/js/player.js"></script>
